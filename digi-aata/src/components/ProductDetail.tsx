    ...
    <div className="bg-surface rounded-xl shadow-soft-warm p-6 md:p-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex justify-center items-center">
          <img src={product.image} alt={product.name} className="w-full max-w-sm h-auto object-cover rounded-lg shadow-soft-warm" />
        </div>
        <div>
          ...
          <p className="text-muted text-sm mb-6">Age: {product.age}</p>
